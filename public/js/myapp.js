...
function showMessage(top, left, width, message) {
  ...
  $tooltip.css('top', top).css('left', left).css('width', width).fadeTo(300, 1);
}
...
window._notify = function (text) {
  $.fancybox.open({
    ...
    opts: {
      ...
      afterLoad: function afterLoad() {// setTimeout(function () {
...
$(document).ready(function () {
  if (!js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('subscriber') && !js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('subscriber-popup')) {
    $('.advertising').css({
      display: 'block'
    });
  }

  $('body').on('click', '.advertising .advertising__button-drop', function () {
    js_cookie__WEBPACK_IMPORTED_MODULE_0___default().set('subscriber-popup', 'n');
    $('.advertising').animate({
      bottom: '-150px'
    });
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (result.html) {
          ...
          $tooltip.css('top', $this.offset().top).css('right', rt).css('max-width', maxwidth_r + 'px').fadeTo(300, 1);
        }
      }
    });
  ...
  $(".full-descr a.detail-title").click(function () {
  ...
  $(".category-popup .all").click(function () {
  ...
  if (windowW < 801) {
    ...
    $(".topmenu ul li.menu-parent .str").click(function () {
      $(this).closest('li').find('ul').slideToggle();
      $(this).closest('li').toggleClass('open');
      return false;
    });
    $(".topmenu ul li.menu-parent .str-v").click(function () {
      $('.category-popup').addClass('open-mobile');
      $('.mainmenu').addClass('static');
      return false;
    });
    $(".category-popup .exit").click(function () {
...
$(function () {
  $('body').on('click', 'button.send_pdf', function () {
  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      if (list.pagecount >= 2 && $('.pagination div').length > 0) {
        ...
        $('.pagination').empty().append('<div>Страница</div>' + '                <div class="form__range">' + '                    <input class="page" type="number" value="' + list.pageid + '" min="1"' + '                           max="' + list.pagecount + '">' + '                </div>' + '                <div>' + '                    из <span class="pagecount">' + list.pagecount + '</span>' + '                </div>' + '                <div class="catalog_pagination__arrows">' + '                    <span class="arrow left" href=""><i class="fas fa-arrow-left"></i></span>' + '                    |' + '                    <span class="arrow right" href=""><i class="fas fa-arrow-right"></i></span>' + '                </div>');
...
;
$(function () {
  var header_search = new _search__WEBPACK_IMPORTED_MODULE_0__.BigSearch({
    'MIN_QUERY_LEN': 3,
    'INPUT': 'q',
...
$(function () {
  $('body').on('click', '.std-form button.save', function () {
...
$(function () {
  $('body').on('click', '.head .right .btns .enter', function (e) {
    var $this = $(this);
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $tooltip.css('top', top).css('right', rt).css('max-width', maxwidth_r + 'px').fadeTo(300, 1);
      }
    });
...
$(function () {
    ...
    $.ajax({
      ...
      success: function success(response) {
        $(response).each(function (i, item) {
          $('#passport-clients').append('<div class="passport-client-row ' + item.id + '">' + '<div class="passport-client-name">' + item.name + '</div>' + '<div class="passport-client-id">' + item.id + '</div>' + '<div class="passport-client-secret">' + item.secret + '</div>' + '<div class="passport-client-redirect">' + item.redirect + '</div>' + '<div class="passport-client-edit" data-id="' + item.id + '"><i class="fas fa-pen"></i></div>' + '<div class="passport-client-delete" data-id="' + item.id + '"><i class="fas fa-trash-alt"></i></div>' + '</div>');
        });
      }
    });
  }
  ...
  if ($('#personal-tokens').length === 1) {
    $.ajax({
      ...
      success: function success(response) {
        $(response).each(function (i, item) {
          $('#personal-tokens').append('<div class="personal-token-row ' + item.id + '" data-id="' + item.id + '">' + '<div class="personal-token-name">' + item.name + '</div>' + '<div class="personal-token-scopes">' + item.scopes.join(", ") + '</div>' + '<div class="personal-token-created_at">' + item.created_at + '</div>' + '<div class="personal-token-expires_at">' + item.expires_at + '</div>' + '<div class="personal-token-delete" data-id="' + item.id + '"><i class="fas fa-trash-alt"></i></div>' + '</div>');
        });
      }
    });
    $.ajax({
      ...
      success: function success(response) {
        $(response).each(function (i, item) {
          $('#scopes').append('<div class="scope-row">' + '<div class="scope-checkbox"><input type="checkbox" name="scopes[' + i + ']" value="' + item.id + '"></div>' + '<div class="scope-description">' + item.description + '</div>' + '</div>');
        });
      }
    });
  }

  $('body').on('click', 'button.create-passport-client', function () {
    ...
    $.ajax({
      ...
      success: function success(response) {
        var item = response;
        $('#passport-clients').append('<div class="passport-client-row ' + item.id + '">' + '<div class="passport-client-name">' + item.name + '</div>' + '<div class="passport-client-id">' + item.id + '</div>' + '<div class="passport-client-secret">' + item.secret + '</div>' + '<div class="passport-client-redirect">' + item.redirect + '</div>' + '<div class="passport-client-edit"><i class="fas fa-pen"></i></div>' + '<div class="passport-client-delete" data-id="' + item.id + '"><i class="fas fa-trash-alt"></i></div>' + '</div>');
        parent.$.fancybox.close();
      }
    });
...
$(function () {
  ...
  var show_promo_footer = function show_promo_footer() {
  ...
  var show_promo_popup = function show_promo_popup() {
    var ya_client_id = yaCounter50258335.getClientID();
    $.ajax({
      type: 'GET',
      url: '/main/get_ya_client_sale_discount_popup/',
        ...
        if (result.popup) {
          $.fancybox.open($('#first_order_promo'), {
            ...
            afterShow: function afterShow() {
              js_cookie__WEBPACK_IMPORTED_MODULE_0___default().remove('show_promo_popup');
              var d = new Date();
              var t = d.toString();
              yaCounter50258335.params({
                promo: {
  ...
  if (!js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('age')) {
    $.fancybox.open($('#age'), {
      modal: true
    });
  } else if (js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('age') && js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('show_promo_popup')) {
    var delta = js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('show_promo_popup') - Date.now();
  ...
  } else if (js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('age') && js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('show_promo_footer')) {
    doWithYaCounter(show_promo_footer);
  }

  $('.js-age-yes').click(function (e) {
    $.fancybox.close();
    js_cookie__WEBPACK_IMPORTED_MODULE_0___default().set('age', 'true', {
      path: '/'
    });
    js_cookie__WEBPACK_IMPORTED_MODULE_0___default().set('show_promo_popup', Date.now() + 10000, {
      path: '/'
    });
    js_cookie__WEBPACK_IMPORTED_MODULE_0___default().set('show_promo_footer', 1, {
      path: '/'
    });
    setTimeout(function () {
      init_promo_popup();
...
$(function () {
  $('body').on('click', '.registration_fb', function () {
    var url = $(this).data('url');
    $(this).parents('.header-window').remove();
    fb_instance = $.fancybox.open({
      src: '#registration',
...
/* harmony export */   "BigSearch": () => (/* binding */ BigSearch),
/* harmony export */   "SearchSearch": () => (/* binding */ SearchSearch)
/* harmony export */ });
var BigSearch = function BigSearch(arParams) {
  var _this = this;
...
var SearchSearch = function SearchSearch(arParams) {
  var _this = this;
...
$(function () {
  ...
  $('body').on('change', '.pagination input.page', function () {
    var change = false;
    var page = +$(this).val();
...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__(/*! ./everypage.js */ "./resources/js/everypage.js");

__webpack_require__(/*! ./common.js */ "./resources/js/common.js");

__webpack_require__(/*! ./creators.js */ "./resources/js/creators.js");

__webpack_require__(/*! ./login.js */ "./resources/js/login.js");

__webpack_require__(/*! ./popups.js */ "./resources/js/popups.js");

__webpack_require__(/*! ./registration.js */ "./resources/js/registration.js");

__webpack_require__(/*! ./banner.js */ "./resources/js/banner.js");

__webpack_require__(/*! ./lazy.js */ "./resources/js/lazy.js");

__webpack_require__(/*! ./table.js */ "./resources/js/table.js");

__webpack_require__(/*! ./form.js */ "./resources/js/form.js");

__webpack_require__(/*! ./passport.js */ "./resources/js/passport.js");
})();
